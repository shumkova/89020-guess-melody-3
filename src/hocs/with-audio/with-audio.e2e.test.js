...
// - замокали HTMLMediaElement методы play и pause
// - получили ref элемента аудио
// - наблюдаем за вызовом метода play/pause у ref с помощью jest.spyOn
// - вызвали componentDidMount, чтобы появилась ссылка на ref
// - кликнули по кнопке "Play"
// - проверили вызов метода play/pause
